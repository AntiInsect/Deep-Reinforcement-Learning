...
class Board:
    ...
    def step(self, action):
        ...
        :param action: <tuple (i, j)> Coordinates of the action.
        :return: <Bool>  Validity of the action.
        """
        i = action[0]
        j = action[1]
        ...
        self.current_player = -self.current_player  # It's turn to opponent.
        return True
