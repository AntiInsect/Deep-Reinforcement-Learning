...
def data_augmentation_new(x_label, y_label):
    ...
    :return: data.  Data after data augmentation.
    """
...
class PolicyValueNet_ResNet(Network):
    ...
    def board_to_xlabel(self, board):
        ...
        # 4: Whether the current player is the first player.
    ...
    def train(self, x_label, y_label):
        """
        Train the model.
        :param x_label: Input neural network labels.
        :param y_label: Output labels for training to be supervised.
        """
    ...
    def evaluate(self, x_label, y_label):
        ...
        :param x_label:  Input of the neural network.
        :param y_label:  Output of the neural network.
        :return: Evaluation of the network.
        """
